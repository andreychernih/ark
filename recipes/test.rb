...
ark 'foo_sub' do
  url 'https://github.com/andreychernih/ark/raw/strip-components/files/default/foo_sub.tar.gz'
  version '1'
  strip_components 2
end

ark 'foo_sub' do
  url 'https://github.com/andreychernih/ark/raw/strip-components/files/default/foo_sub.zip'
  version '2'
  strip_components 2
end
